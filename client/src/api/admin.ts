...
export async function adminListProjects(
  ...
  const { data } = await axiosForBackend.get('/api/admin/projects', {
...
export async function adminSetProjectHidden(
  ...
  await axiosForBackend.patch(`/api/admin/projects/${id}/hidden`, { isHidden });
}
...
export async function adminSetProjectPinned(
  ...
  await axiosForBackend.patch(`/api/admin/projects/${id}/pinned`, { isPinned });
}

export async function adminDeleteProject(id: string): Promise<void> {
  await axiosForBackend.delete(`/api/admin/projects/${id}`);
}
...
export async function adminListGallery(
  ...
  const { data } = await axiosForBackend.get('/api/admin/gallery', {
    params: { page, pageSize },
  });
  return data;
}
...
export async function adminSetGalleryPinned(
  ...
  await axiosForBackend.patch(`/api/admin/gallery/${id}/pinned`, { isPinned });
}

export async function adminDeleteGalleryItem(id: string): Promise<void> {
  await axiosForBackend.delete(`/api/admin/gallery/${id}`);
}

export async function adminDeleteGalleryComment(id: string): Promise<void> {
  await axiosForBackend.delete(`/api/admin/gallery/comments/${id}`);
}
...
export async function adminListFeedbacks(
  ...
  const { data } = await axiosForBackend.get('/api/admin/feedbacks', {
    params: { page, pageSize },
  });
  return data;
}
...
export async function adminUpdateFeedbackStatus(
  ...
  await axiosForBackend.patch(`/api/admin/feedbacks/${id}/status`, { status });
}
